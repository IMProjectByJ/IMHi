...
public class TestData {
    ...
    public static ArrayList<ItemModel> getTestAdData() {
        ...
        model6.setContent("你是妹子，卧槽，我怎么没看出来？爱神的箭啊离开家的");
        ...
        model7.setContent("你是妹子，卧槽，我怎么没看出来？");
        model7.setIcon("http://img.my.csdn.net/uploads/201508/05/1438760758_6667.jpg");
        models.add(new ItemModel(ItemModel.CHAT_B, model7));
        return models;
    }
}
